...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Penyakit Karat Daun Admin</title>
    ...
    <body>
        ...
        <article> 
            <div class="isi1">  
                <div class="judul1"> 
                    <h2>Penyakit Karat Daun</h2>
                </div>
                <br>
                <img src="../../images/karat daun jagung.jpg" > 
                <br><br>
                <p> 
                Deskripsi Penyakit
                </p>
                ...
                1. Tanam varietas tahan seperti Kalingga, Arjuna, Wiyasa, Pioneer-2. Hibrida Cl sangat peka terhadap penyakit ini. <br>
                2. Gunakan fungisida triadomefon atau golongan dithiokarbamat secara semprotan. <br>
                <br>
