...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Penyakit Mosaik Jagung Admin</title>
    ...
    <body>
        ...
        <article> 
            <div class="isi1">  
                <div class="judul1"> 
                    <h2>Penyakit Mosaik Jagung</h2>
                </div>
                <br>
                <img src="../../images/mosaik jagung.jpg" > 
                <br><br>
                <p> 
                Deskripsi Penyakit
                </p>
                Penyakit mosaik jagung adalah penyakit yang disebabkan oleh virus mosaik jagung melalui serangga loncat. Sebaran penyakit mosaik jagung meliputi Amerika, Australia, Asia Tenggara, dan Afrika. Gejala mosaik jagung ini sering dikacaukan dengan gejala penyakit bulai. Ciri khas dari penyakit ini yaitu daun berwarna mosaik.
                <br><br>
                <p>
                Solusi Penanganan Penyakit
                </p>
                1. Tanam varietas tahan, seperti galur murni. <br>
                2. Lakukan penyiangan dua kali. <br>
                <br>
