...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Penyakit Bulai Jagung Admin</title>
    ...
    <body>
        ...
        <article> 
            <div class="isi1">  
                <div class="judul1"> 
                    <h2>Penyakit Bulai Jagung</h2>
                </div>
                <br>
                <img src="../../images/bulai jagung.jpg" > 
                <br><br>
                <p> 
                Deskripsi Penyakit
                </p>
                Bulai merupakan penyakit yang disebabkan oleh jamur Peronosclerospora maydis maupun Peronosclerospora philippinensis. Jamur P. maydis ditemukan di seluruh wilayah Indonesia, sedang P. philippinensis ditemukan di Sulawesi Utara, dan di negara Filipina, Taiwan, Muangthai, dan India. Gejala yang terdapat pada tanaman yang terinfeksi penyakit ini yaitu pada permukaan daun 
                terdapat garis-garis sejajar tulang daun berwarna putih sampai kuning diikuti dengan garis-garis khlorotik sampai coklat bila infeksi makin lanjut. Kerugian        hasil panen yang ditimbulkan oleh penyakit ini dapat mencapai 100%.
                <br><br>
                <p>
                Solusi Penanganan Penyakit
                </p>
                1. Tanam varietas jagung yang tahan bulai seperti Kalingga, Arjuna, Wiyasa, Bromo, Parikesit, dan Hibrida C. <br>
                2. Tidak menanam benih jagung yang berasal dari tanaman sakit. <br>
                3. Tanam jagung secara serempak pada awal sampai akhir musim kemarau. Penanaman jagung pada peralihan musim (marengan atau labuhan) akan menderita kerugian besar karena bulai. <br>
                4. Perlakuan benih dengan fungisida sistemik seperti Ridomil 35 SD (5 g formulasi/kg benih Ridomil mengandung bahan aktif metalaksil 35%). <br>
                <br>
