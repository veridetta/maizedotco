...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Penyakit Busuk Pelepah Admin</title>
    ...
    <body>
        ...
        <article> 
            <div class="isi1">  
                <div class="judul1"> 
                    <h2>Penyakit Busuk Pelepah</h2>
                </div>
                <br>
                <img src="../../images/busuk pelepah.jpg" > 
                <br><br>
                <p> 
                Deskripsi Penyakit
                </p>
                Busuk pelepah merupakan penyakit yang disebabkan oleh jamur Rhizoctonia zeae. Gejala awal dari penyakit ini tampak pada permukaan pelepah bercak jamur berwarna salmon, kemudian berubah jadi abu-abu pudar. Bercak meluas dan terpisah-pisah seperti gejala panu dan sering diikuti pembentukan sklerotia 
                dengan bentuk tidak beraturan, berkesan seperti cipratan tanah, berwarna putih, salmon sampai coklat gelap. Varietas jagung dengan pelepah daun yang rapat sampai ke tanah paling mudah terinfeksi
                <br><br>
                <p>
                Solusi Penanganan Penyakit
                </p>
                1. Tanam varietas tahan. <br>
                2. Pilih varietas dengan pelepah berkurang di bawah batang untuk menghindari perkembangan penyakit. <br>
                3. Sebaiknya menanam jagung pada awal musim kemarau. <br>
                <br>
