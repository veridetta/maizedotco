...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Penyakit Bercak Daun Admin</title>
    ...
    <body>
        ...
        <article> 
            <div class="isi1">  
                <div class="judul1"> 
                    <h2>Penyakit Bercak Daun</h2>
                </div>
                <br>
                <img src="../../images/bercak daun.jpg" > 
                <br><br>
                <p> 
                Deskripsi Penyakit
                </p>
                Bercak daun merupakan penyakit yang disebabkan oleh jamur Helminthosporium maydis. Penyakit ini memiliki dua tipe bercak menurut ras patogennya yaitu bercak karena ras 0 dan ras T. Ras 0 biasanya menyerang daun dan bercaknya lebih sejajar sisi daun, tongkol jarang diserang pada jagung yang bersitoplasma normal, sehingga kerugian oleh ras 0 ini kurang berarti. Ras T sangat virulen terhadap jagung bersitoplasma jantan mandul. Bibit jagung bila terserang menjadi layu sampai mati dalam waktu 3-4 minggu setelah tanam. Bila tongkol terinfeksi lebih dini, biji-biji akan rusak dan busuk, bahkan tongkol dapat gugur. Penyakit ini sudah tersebar di seluruh dunia (bersifat kosmopolitan) dan sangat penting di daerah yang bersuhu hangat antara 20 sampai 32°C dan lembab. Bila terjadi serangan H. maydis ras T pada jagung bersitoplasma jantan mandul dapat terjadi kerugian hasil 90%.
                <br><br>
                <p>
                Solusi Penanganan Penyakit
                </p>
                1. Gunakan varietas tahan. <br>
                2. Pembajakan tanah yang bersih dapat mengurangi infeksi. <br>
                3. Hindari menanam jagung terlalu rapat. <br>
                4. Gunakan fungisida sistemik, terutama sejak bunga jantan muncul dengan interval 7-10 hari.<br>
                5. Hindari menanam jagung yang bersitoplasma jantan mandul. <br>
                <br>
