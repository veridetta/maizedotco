...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Penyakit Busuk Batang Admin</title>
    ...
    <body>
        ...
        <article> 
            <div class="isi1">  
                <div class="judul1"> 
                    <h2>Penyakit Busuk Batang</h2>
                </div>
                <br>
                <img src="../../images/busuk batang.jpg" > 
                <br><br>
                <p> 
                Deskripsi Penyakit
                </p>
                Busuk batang merupakan penyakit yang disebabkan oleh jamur busuk batang seperti Diplodia maydis, Gibberella roseum f.sp. cerealis, Fusarium moniliforme. Keadaan cuaca kering pada saat tanam jagung dengan suhu hangat (28-30°C) dan udara basah pada 2-3 minggu setelah pembentukan bulu jagung sangat baik bagi perkembangan busuk batang. 
                Kandungan nitrogen dan kalium rendah, populasi tanaman tinggi (sangat rapat), kerusakan karena hujan deras dan serangga dapat melemahkan tanaman jagung terhadap infeksi. Daerah sebaran penyakit busuk batang mencakup seluruh dunia dan kerugian hasil panen akibat penyakit dapat mencapai 40% pada musim hujan.
                <br><br>
                <p>
                Solusi Penanganan Penyakit
                </p>
                1. Tanam varietas tahan diplodia dan varietas tahan dengan tongkol tertutup sempurna. <br>
                2. Jaga kesuburan tanah yang berimbang. <br>
                3. Atur populasi tanaman agar jangan terlalu rapat.. <br>
                4. Hindari penanaman pada musim penghujan. <br>
                5. Lakukan sanitasi dan rotasi. <br>
                6. Gunakan fungisida efektif secara semprotan.<br>
                7. Tanam benih sehat (kadar air 14 %). <br>
                <br>
