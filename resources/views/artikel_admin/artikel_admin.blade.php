...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Artikel Tentang Jagung Admin</title>
    ...
    <body>
                                    ...
                                    <li class="navbar-item navbar-dropdown navbar-megamenu">
                                        ...
                                        <div class="megamenu">
                                            <ul>
                                                ...
                                                <li><a href="/info-admin" onclick="loadPage()">
        ...
        <article>
            <h1>ARTIKEL SEPUTAR TENTANG JAGUNG</h1>
            <br><br>
            <div class="contrainer">
                <div class="card">
                    <img src="../../images/gambar1.jpg" alt="Penyakit Tanaman Jagung" style="width: 368px; height: 200px; border-radius: 3px;"> 
                    <a href="/artikel1_admin">Kisah Sarjana yang Memilih Bertani Jagung, Kini Sehari Bisa Raup Rp 300 Juta</a>
            </div>

            <div class="contrainer">
                <div class="card">
                    <img src="../../images/gambar2.jpg" alt="46,2 Hektar Lahan Jagung Berpotensi Alami Gagal" style="width: 368px; height: 200px; border-radius: 3px;">
                    <a href="/artikel2_admin">46,2 Hektar Lahan Jagung Berpotensi Alami Gagal</a>
            </div>

            <div class="contrainer">
                <div class="card">
                    <img src="../../images/gambar3.jpeg" alt="8 Hama Pada Tanaman Jagung" style="width: 368px; height: 200px; border-radius: 3px;">
                    <a href="/artikel3_admin">Jagung Melimpah, Petani Sejahtera</a>
            </div>
        </article>
