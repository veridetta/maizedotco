...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Fitur TaskMinder Admin</title>
    ...
    <body>
        ...
        <article>
            <div class="isi">  
                <div class="judul"> 
                    <h1>Mengapa Website Maizedotco Terdapat Fitur TaskMinder</h1>
                </div>
                <br>
                <img src="../images/banner/jagung.3.png" > 
                <br><br>
                <p> 
                    Fitur task minder bertujuan untuk mencegah terjadinya gagal panen seperti pada kasus di daerah Lampung.Pemupukan yang tidak tepat waktu dapat menyebabkan kegagalan panen. Dengan alarm, Petani Jagung dapat menghindari risiko ini dan meningkatkan kemungkinan kesuksesan panen.
                    <a href="https://www.kupastuntas.co/2022/08/17/pemupukan-kerap-telat-petani-jagung-di-lampung-kehilangan-pendapatan-rp66-juta-per-tahun">Klik disini untuk melihat lebih jelas</a><br>
                </p>
            </div> 
        </article>
