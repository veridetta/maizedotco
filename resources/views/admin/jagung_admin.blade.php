...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Topik Jagung Admin</title>
    ...
    <body>
        ...
        <article>
            <div class="isi">  
                <div class="judul"> 
                    <h1>Mengapa Website Maizedotco Mengambil Topik Jagung ?</h1>
                </div>
                <br>
                <img src="../images/banner/jagung.1.png" > 
                <br><br>
                <p> 
                    Jagung (Zea mays) merupakan tanaman pangan utama ketiga setelah padi 
                    dan gandum di dunia dan menempati posisi kedua setelah padi di Indonesia.
                    Jagung juga merupakan salah satu tanaman serealia (sereal atau biji-bijian) yang 
                    strategis dan bernilai ekonomis serta mempunyai peluang untuk dikembangkan
                    menjadi produk olahan karena kedudukannya sebagai sumber utama karbohidrat 
                    dan protein setelah beras. <br>
                </p>
            </div> 
        </article>
