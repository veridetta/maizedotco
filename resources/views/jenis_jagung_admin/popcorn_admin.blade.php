...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Jagung Berondong Admin</title>
    ...
    <body>
        ...
        <article> 
            <div class="isi">  
                <div class="judul"> 
                    <h1>Jagung Berondong (Zea mays everta) </h1>
                </div>
                <br>
                <img src="../../images/popcorn.jpg" > 
                <br><br>
                <p> 
                    Sama seperti namanya, jagung berondong merupakan bahan baku utama dalam pembuatan popcorn atau berondong jagung. <br><br>

                    Ciri-ciri :<br>
                        •	Biji: bulat, kecil dan keras. Berwarna kuning, putih, merah muda, ungu, atau campuran warna tersebut.<br>
                        •	Kelembapan: berkisar 14% sampai 20% dan akan berubah menjadi uap saat dipanaskan. Biji jagung berondong dapat mengembang hingga 10 sampai 30 kali lebih besar dari ukuran awal.<br>
                        •	Kulit pericarp yang keras.<br>
                        •	Kandungan air: memiliki kandungan air yang rendah, biasanya kurang dari 14%.<br>
                        •	Tinggi Tanaman: sekitar 1,5 hingga 2 meter.<br>
                        •	Tingkat Manis: jagung popcorn tidak memiliki rasa manis atau bahkan gurih ketika dimakan dalam bentuk popcorn.<br>
                        •	Pemanenan: Jagung popcorn biasanya dipanen ketika bijinya sudah matang, tetapi masih harus dipanaskan untuk membuat popcorn yang meletup. Pemanenan dapat dilakukan secara manual atau mekanis, tergantung pada skala produksinya.<br>
                </p>
            </div> 
        </article>
