...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Jagung Polong Admin</title>
    ...
    <body>
        ...
        <article> 
            <div class="isi">  
                <div class="judul"> 
                    <h1>Jagung Polong (Zea mays aunicula)</h1>
                </div>
                <br>
                <img src="../../images/jagungpolong.jpg" > 
                <br><br>
                <p> 
                    Jagung polong dikenal juga sebagai pod corn atau jagung liar. 
                    Pertama kali ditemukan di Amerika Selatan, jagung pod tidak dapat dimakan. 
                    Karena memiliki tampilan menarik, biji jagung ini hanya digunakan sebagai hiasan.<br><br>

                    Ciri-ciri :<br>
                        •	Tinggi Tanaman: Jagung polong biasanya lebih pendek dibandingkan dengan jenis jagung yang tumbuh untuk biji. Tanaman jagung polong biasanya mencapai ketinggian antara 1,5 hingga 2,5 meter. <br>
                        •	Batang: berwarna hijau dan silindris. <br>
                        •	Daun: berwarna hijau muda hingga hijau tua. Daunnya panjang dan lebar dengan tulang daun yang jelas terlihat. <br>
                        •	Tangkai Polong: pada jagung polong adanya polong yang terbentuk pada tangkai tanaman.  Polong jagung polong biasanya berwarna hijau, dan panjangnya bisa bervariasi. <br>
                        •	Biji: berukuran lebih kecil daripada biji jagung yang tumbuh untuk tujuan pangan. Biji-bijian ini memiliki warna yang beragam, termasuk kuning, putih, merah, atau bahkan ungu, tergantung pada varietasnya.<br>
                        •	Bentuk dan Warna Polong: biasanya lebih panjang daripada polong biji jagung, dan warnanya bisa hijau, kuning muda, atau merah muda.<br>
                        •	Pemanenan: Jagung polong biasanya dipanen ketika polongnya masih muda dan bijinya belum mengeras. Ini adalah waktu ketika jagung polong memiliki rasa manis yang maksimal.<br>
                </p>
            </div> 
        </article>
