...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Jagung Mutiara Admin</title>
    ...
    <body>
        ...
        <article> 
            <div class="isi">  
                <div class="judul"> 
                    <h1>Jagung Mutiara (Zea mays indurata)</h1>
                </div>
                <br>
                <img src="../../images/jagungmutiara.jpg" > 
                <br><br>
                <p>
                    Ternyata jenis jagung mutiara atau flint corn banyak tumbuh di Indonesia, khususnya di Pulau Jawa. 
                    Para petani lebih senang menanam jagung mutiara karena tahan terhadap hama gudang. Di Indonesia sendiri, jagung mutiara banyak dimanfaatkan sebagai pakan ternak atau dikonsumsi oleh masyarakat. 
                    Sedangkan di negara Amerika dan Argentina, jagung ini hanya digunakan sebagai pakan ternak saja.<br><br>

                    Ciri-ciri: <br>
                        •	Biji: memiliki warna biji yang lebih dari satu warna. Bentuknya bulat, agak kecil, keras, dan licin. <br>
                        •	Warna Polong: berwarna putih atau hijau muda.<br>
                        •	Rasa: memiliki rasa yang lezat dan sedikit manis. Rasa manisnya biasanya lebih ringan daripada jagung manis. <br>
                        •	Tinggi Tanaman: biasanya tidak terlalu tinggi, yaitu sekitar 1,5 hingga 2 meter.<br>
                        •	Pemanenan: dilakukan ketika bijinya sudah cukup matang, tetapi sebelum biji mengeras sepenuhnya. <br>
                        •	Penggunaan: sering digunakan dalam berbagai hidangan, terutama dalam hidangan Asia seperti bubur mutiara (tapioka pearl) dan hidangan penutup seperti es krim mutiara atau sup mutiara. Mereka juga digunakan dalam hidangan gurih seperti sup atau bubur.<br>
                        •	Kandungan Nutrisi: mengandung karbohidrat kompleks, serat, vitamin B, dan mineral seperti mangan.<br>
                </p>
            </div> 
        </article>
