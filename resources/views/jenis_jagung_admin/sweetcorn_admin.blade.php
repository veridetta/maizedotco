...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Jagung Manis Admin</title>
    ...
    <body>
        ...
        <article> 
            <div class="isi">  
                <div class="judul"> 
                    <h1>Jagung Manis (Zea mays saccharata)</h1>
                </div>
                <br>
                <img src="../../images/jagungmanis.png" > 
                <br><br>
                <p> 
                    Jagung manis atau sweet corn merupakan salah satu jenis jagung yang saat ini mulai berkembang dan mempunyai prospek penting di Indonesia.<br><br>
                    Ciri-ciri : <br>
                        •	Batang: Berwarna hijau. <br>
                        •	Kepala sari (anther): Berwarna kuning. <br>
                        •	Rambut tongkol: Berwarna kuning. <br>
                        •	Biji: Berwarna kuning, menyerupai kaca dan mempunyai zat pati yang manis. <br>
                        •	Tinggi tanaman (cm): 111.24 ± 18.36. <br>
                        •	Tinggi tongkol (cm): 47.15 ± 13.48. <br>
                        •	Panjang daun (cm): 65.28 ± 9.62. <br>
                        •	Kandungan lemak pada jagung manis lebih tinggi daripada jagung lain.<br>
                </p>
            </div> 
        </article>
