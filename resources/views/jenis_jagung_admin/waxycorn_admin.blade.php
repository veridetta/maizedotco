...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Jagung Ketan Admin</title>
    ...
    <body>
        ...
        <article> 
            <div class="isi">  
                <div class="judul"> 
                    <h1>Jagung Ketan (Zea mays ceratina)</h1>
                </div>
                <br>
                <img src="../../images/jagungketan.jpg" > 
                <br><br>
                <p>
                    Jagung ketan atau waxy corn berasal dari Asia yang memiliki ciri khas pada bijinya yang putih mengkilap. 
                    Jagung ketan biasanya digunakan dalam berbagai hidangan dan makanan penutup di berbagai negara, terutama di Asia Tenggara, sebagai bahan dasar untuk makanan seperti ketan, kue klepon, lemper, dan masih banyak lagi. 
                    Jagung ketan akan terasa lengket bila dimasak, hal tersebut disebabkan karena dalam jagung ketan terdapat kandungan amilopektin yang cukup tinggi. <br><br>

                    Ciri-ciri: <br>
                        •	Bentuk dan Ukuran Polong: cenderung lebih kecil, pendek dan bulat jika dibandingkan dengan jagung biasa.<br>
                        •	Warna Polong: berwarna putih atau keperakan.<br>
                        •	Biji Jagung: memiliki sifat yang lengket ketika dimasak.<br>
                        •	Tinggi Tanaman: biasanya kurang dari 2 meter.<br>
                        •	Daun: berwarna hijau dan berbentuk lanset.<br>
                        •	Pemanenan: Pemanenan jagung ketan biasanya dilakukan ketika bijinya sudah cukup matang dan polongnya sudah mengeras. <br>
                </p>
            </div> 
        </article>
