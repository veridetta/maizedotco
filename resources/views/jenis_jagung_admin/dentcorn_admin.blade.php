...
<html lang="en">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Jagung Gigi Kuda Admin</title>
    ...
    <body>
        ...
        <article> 
            <div class="isi">  
                <div class="judul"> 
                    <h1>Jagung Gigi Kuda (Zea mays identata)</h1>
                </div>
                <br>
                <img src="../../images/jagunggigikuda.png" > 
                <br><br>
                <p> 
                Jagung gigi kuda atau dent corn paling banyak ditemukan di Amerika Serikat. 
                Biasanya, jagung ini dimanfaatkan sebagai bahan baku untuk pembuatan tepung jagung, roti jagung, keripik jagung, dan beberapa jenis makanan lainnya. 
                Kandungan pati pada jagung gigi kuda yang tinggi sering diolah menjadi plastik. Kemudian, fruktosannya biasanya dipakai sebagai pemanis pada berbagai olahan makanan dan minuman.<br>
                
                Memiliki ciri -ciri biji yang memiliki lekukan di bagian tengah atau atas biji dan ukuran biji cukup besar. 
                Ada dua kategori hibrida jagung gigi kuda, biasanya digolongkan berdasarkan warna bijinya, yaitu kuning atau putih.
                Jagung gigi kuda yang berwarna kuning sering digunakan sebagai pakan ternak dan keperluan industri. Sedangkan jagung gigi kuda putih biasanya diproduksi sebagai bahan konsumsi manusia.<br>
                </p>
            </div> 
        </article>
