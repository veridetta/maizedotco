                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="header-option">
                            ...
                            <a id="logoutButton" class="success-button" style="display:inline-block; background-color:#82CD47; color:white; padding:10px 20px; text-decoration:none; border:none; border-radius:5px; font-weight:bold;" href="/index">Logout</a>
...
{{-- <ol style="border: 1px solid black; border-radius: 5px; padding: 50px; width: 20%; padding: 20px;">
    ...
    <div class="gallery">
        ...
        <div class="content">
            ...
            <br>
            <button><a href="https://wa.me/6287735560238" target="_blank">Beli Sekarang</a></button>
        </div>
