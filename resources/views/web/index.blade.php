                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="header-option">
                            ...
                            <a class="btn btn-xs" style="color: white" href="/loginpage">Login</a>
                        ...
                        <div class="navbar-slide">
                            <div class="navbar-content">
                                ...
                                <ul class="navbar-list">
                                    ...
                                    <li class="navbar-item"><a class="navbar-link" href="t.minder.php">Task Minder</a>
                                        <script>
                                    ...
                                    <li class="navbar-item navbar-dropdown navbar-megamenu">
                                        ...
                                        <div class="megamenu">
                                            <ul>
                                                <li><a href="index" onclick="loadPage()">
                                    ...
                                    <li class="navbar-item"><a class="navbar-link" href="index.php">Maize MindShare</a>
                                        <script>
                                            window.document.onclick = function() {
                                                alert('Anda harus login terlebih dahulu!');
                                            };
            ...
            <div class="row">
                ...
                <div class="col-md-7 col-lg-6">
                    <div class="banner-content-1">
                        <a href="ssejarah.php"><h1>Mengapa Website Maizedotco Mengambil Topik Jagung ?</h1></a><br><br>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-content-2">
                        <a href="kkandungan.php"><h1>Mengapa Website Maizedotco Terdapat Fitur JeKit ?</h1></a>
            ...
            <div class="row">
                <div class="col-md-7 col-lg-6">
                    <div class="banner-content-3">
                        <a href="mmaizedotco.php"><h1>Mengapa Website Maizedotco Terdapat Fitur TaskMinder ?</h1></a>
