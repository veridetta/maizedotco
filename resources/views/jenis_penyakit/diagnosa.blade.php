    ...
    <body>
        ...
        <article>
            <div class="isi">  
                ...
                <p>Tentukan Pilihan Bagian Jagung :</p>
                <select id="bagian_jagung">
                    <option>Daun</option>
                ...
                <p>Tentukan Pilihan Gejala :</p>
                <select id="pilihan_gejala">
                </select>
                <br><br>

                <button id="btn_diagnosis" style="background-color:#82CD47'">diagnosis</button>

                <p id="hasil_pilihan"></p>
            </div> 
        </article>
